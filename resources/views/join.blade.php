    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <p>The organisation's people management practices have been developed, using world class standards with clear and specific aims which include:
                <ul class="ml-5">
                    <li>Fostering the individual strengths, talents and aspirations of each of our employees;</li>
                    <li>Providing a rich and stimulating working environment for employees to contribute to the overall success of the School</li>
                </ul>
                In joining us, you would be associated with a world class team of highly motivated individuals from diverse backgrounds, knowledge, experiences and abilities.

            </p>

            <p>If you are a self-starter who is seeking for a more exciting and challenging career with significant opportunities for self-development and real impact on the society, then ACCE is the place for you.</p>
            <p>Join us.</p>
        </div>
    </div>
</div>
